...
<html lang="en">
    ...
    <body>
        ...
        <br/>
        <div> da: ${jspvalda} </div>
        <div> db: ${jspvaldb} </div>    <!-- CWEID 80 -->
        <div> dc: ${jspvaldc} </div>
        <div> dd: ${jspvaldd} </div>    <!-- CWEID 80 -->
        <div>
            de: 
            <div> val1: ${jspvalde.val1} </div> <!-- CWEID 80 -->
            <div> val2: ${jspvalde.val2} </div>
            <div> val3: ${jspvalde.val3} </div> <!-- CWEID 80 -->
        </div>
        <div>
            df: 
            <div> val1: ${jspvaldf.val1} </div> <!-- CWEID 80 -->
            <div> val2: ${jspvaldf.val2} </div>
            <div> val3: ${jspvaldf.val3} </div>
        </div>

        <br />
        <div> ca: ${jspvalca} </div>    <!-- CWEID 80 -->
        <div> cb: ${jspvalcb} </div>
        <div> cc: ${jspvalcc} </div>    <!-- CWEID 80 -->
        <div> cd: ${jspvalcd} </div>
        <div> ce: ${jspvalce} </div>    <!-- CWEID 80 -->
        <div> cf: ${jspvalcf} </div>
        <div> cg: ${jspvalcg} </div>    <!-- CWEID 80 -->
        <div> ch: ${jspvalch} </div>
        <div> ci: ${jspvalci} </div>    <!-- CWEID 80 -->

        <div>
            cj: 
            <div> val1: ${jspvalcj.val1} </div>
            <div> val2: ${jspvalcj.val2} </div>
            <div> val3: ${jspvalcj.val3} </div> <!-- CWEID 80 -->
        </div>
        <div>
            ck: 
            <div> val1: ${jspvalck.val1} </div>
            <div> val2: ${jspvalck.val2} </div> <!-- CWEID 80 -->
