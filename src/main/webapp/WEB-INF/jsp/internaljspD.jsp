...
<html lang="en">
    ...
    <body>
        ...
        <div> ha: ${jspvalha} </div>
        <div> hb: ${jspvalhb} </div>    <!-- CWEID 80 -->
        <div> hc: ${jspvalhc} </div>
        <div> hd: ${jspvalhd} </div>    <!-- CWEID 80 -->
        <div> he: ${jspvalhe} </div>
        <div> hf: ${jspvalhf} </div>    <!-- CWEID 80 -->
        <div> hg: ${jspvalhg} </div>
        <div> hh: ${jspvalhh} </div>    <!-- CWEID 80 -->
        <div> hi: ${jspvalhi} </div>
        <div> hj: ${jspvalhj} </div>    <!-- CWEID 80 -->
        <div> hk: ${jspvalhk} </div>
        <div> hl: ${jspvalhl} </div>    <!-- CWEID 80 -->
        <div> hm: ${jspvalhm} </div>
        <div> hn: ${jspvalhn} </div>    <!-- CWEID 80 -->
        <div> ho: ${jspvalho} </div>
        <div> hp: ${jspvalhp} </div>    <!-- CWEID 80 -->
        <div> hs: ${jspvalhs} </div>
        <div> ht: ${jspvalht} </div>    <!-- CWEID 80 -->
        <div>
            hq: 
            <div> val1: ${jspvalhq.val1} </div>
            <div> val2: ${jspvalhq.val2} </div>
            <div> val3: ${jspvalhq.val3} </div> <!-- CWEID 80 -->
        </div>
        <div>
            hr: 
            <div> val1: ${jspvalhr.val1} </div>
            <div> val2: ${jspvalhr.val2} </div> <!-- CWEID 80 -->
