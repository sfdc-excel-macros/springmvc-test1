...
<html lang="en">
    ...
    <body>
        ...
        <div> ad: ${jspvalad} </div>    <!-- CWEID 80 -->
        <div> ae: ${jspvalae} </div>
        <div> af: ${jspvalaf} </div>    <!-- CWEID 80 -->
        <div> ag: ${jspvalag} </div>
        <div> ah: ${jspvalah} </div>    <!-- CWEID 80 -->
        <div> ai: ${jspvalai} </div>
        <div> aj: ${jspvalaj} </div>    <!-- CWEID 80 -->
        <div> ak: ${jspvalak} </div>
        <div> al: ${jspvalal} </div>    <!-- CWEID 80 -->
        <div>
            am: 
            <div> val1: ${jspvalam.val1} </div>
            <div> val2: ${jspvalam.val2} </div>    <!-- CWEID 80 -->
            <div> val3: ${jspvalam.val3} </div>
        </div>
        <div>
            an: 
            <div> val1: ${jspvalan.val1} </div>    <!-- CWEID 80 -->
