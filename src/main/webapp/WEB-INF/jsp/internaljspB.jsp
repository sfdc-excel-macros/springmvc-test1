...
<html lang="en">
    ...
    <body>
        ...
        <div> fa: ${jspvalfa} </div>
        <div> fb: ${jspvalfb} </div>    <!-- CWEID 80 -->
        <div> fc: ${jspvalfc} </div>
        <div> fd: ${jspvalfd} </div>    <!-- CWEID 80 -->
        <div> fe: ${jspvalfe} </div>
        <div> ff: ${jspvalff} </div>    <!-- CWEID 80 -->
        <div> fg: ${jspvalfg} </div>
        <div> fh: ${jspvalfh} </div>    <!-- CWEID 80 -->
        <div> fi: ${jspvalfi} </div>
        <div> fj: ${jspvalfj} </div>    <!-- CWEID 80 -->
        <div> fk: ${jspvalfk} </div>
        <div> fl: ${jspvalfl} </div>    <!-- CWEID 80 -->
        <div> fm: ${jspvalfm} </div>
        <div> fn: ${jspvalfn} </div>    <!-- CWEID 80 -->
        <div> fo: ${jspvalfo} </div>
        <div> fp: ${jspvalfp} </div>    <!-- CWEID 80 -->
        <div>
            fq: 
            <div> val1: ${jspvalfq.val1} </div>
            <div> val2: ${jspvalfq.val2} </div>
            <div> val3: ${jspvalfq.val3} </div> <!-- CWEID 80 -->
        </div>
        <div>
            fr: 
            <div> val1: ${jspvalfr.val1} </div>
            <div> val2: ${jspvalfr.val2} </div> <!-- CWEID 80 -->
