...
<html lang="en">
    ...
    <body>
        ...
        <div> ga: ${jspvalga} </div>
        <div> gb: ${jspvalgb} </div>    <!-- CWEID 80 -->
        <div> gc: ${jspvalgc} </div>
        <div> gd: ${jspvalgd} </div>    <!-- CWEID 80 -->
        <div> ge: ${jspvalge} </div>
        <div> gf: ${jspvalgf} </div>    <!-- CWEID 80 -->
        <div> gg: ${jspvalgg} </div>
        <div> gh: ${jspvalgh} </div>    <!-- CWEID 80 -->
        <div> gi: ${jspvalgi} </div>
        <div> gj: ${jspvalgj} </div>    <!-- CWEID 80 -->
        <div> gk: ${jspvalgk} </div>
        <div> gl: ${jspvalgl} </div>    <!-- CWEID 80 -->
        <div> gm: ${jspvalgm} </div>
        <div> gn: ${jspvalgn} </div>    <!-- CWEID 80 -->
        <div> go: ${jspvalgo} </div>
        <div> gp: ${jspvalgp} </div>    <!-- CWEID 80 -->
        <div> gs: ${jspvalgs} </div>
        <div> gt: ${jspvalgt} </div>    <!-- CWEID 80 -->
        <div>
            gq: 
            <div> val1: ${jspvalgq.val1} </div>
            <div> val2: ${jspvalgq.val2} </div>
            <div> val3: ${jspvalgq.val3} </div> <!-- CWEID 80 -->
        </div>
        <div>
            gr: 
            <div> val1: ${jspvalgr.val1} </div>
            <div> val2: ${jspvalgr.val2} </div> <!-- CWEID 80 -->
        ...
        <div> internalvala: ${internalvala} </div> <!-- CWEID 80 -->
        <div> internalvalb: ${internalvalb} </div>
        <div> internalvalc: ${internalvalc} </div>
        <div> internalvald: ${internalvald} </div>  <!-- CWEID 80 -->
        ...
        <div>
            ...
            <div> val3: ${jspvalbq.val3} </div>
        </div>
        <div>
            br: 
            <div> val1: ${jspvalbr.val1} </div>
            <div> val2: ${jspvalbr.val2} </div>
            <div> val3: ${jspvalbr.val3} </div>
        </div>

        <div> injected bean:
            <div> val1: ${bbean.val1} </div>    <!-- CWEID 80 -->
            <div> val2: ${bbean.val2} </div>    <!-- CWEID 80 -->
            <div> val3: ${bbean.val3} </div>
        </div>
        <div> voidvala: ${voidvala} </div>
