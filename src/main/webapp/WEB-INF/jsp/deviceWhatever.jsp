...
<div>
        ...
        <div> ja: ${jspvalja} </div>
        <div> jb: ${jspvaljb} </div>    <!-- CWEID 80 -->
        <div> jc: ${jspvaljc} </div>
        <div> jd: ${jspvaljd} </div>    <!-- CWEID 80 -->
        <div> je: ${jspvalje} </div>
        <div> jf: ${jspvaljf} </div>    <!-- CWEID 80 -->
        <div> jg: ${jspvaljg} </div>
        <div> jh: ${jspvaljh} </div>    <!-- CWEID 80 -->
        <div> ji: ${jspvalji} </div>
        <div> jj: ${jspvaljj} </div>    <!-- CWEID 80 -->
        <div> jk: ${jspvaljk} </div>
        <div> jl: ${jspvaljl} </div>    <!-- CWEID 80 -->
        <div> jm: ${jspvaljm} </div>
        <div> jn: ${jspvaljn} </div>    <!-- CWEID 80 -->
        <div> jo: ${jspvaljo} </div>
        <div> jp: ${jspvaljp} </div>    <!-- CWEID 80 -->
        <div>
            jq: 
            <div> val1: ${jspvaljq.val1} </div>
            <div> val2: ${jspvaljq.val2} </div>
            <div> val3: ${jspvaljq.val3} </div> <!-- CWEID 80 -->
        </div>
        <div>
            jr: 
            <div> val1: ${jspvaljr.val1} </div>
            <div> val2: ${jspvaljr.val2} </div> <!-- CWEID 80 -->
