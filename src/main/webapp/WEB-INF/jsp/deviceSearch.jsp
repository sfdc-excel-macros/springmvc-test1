...
<div>
        ...
        <div> ia: ${jspvalia} </div>
        <div> ib: ${jspvalib} </div>    <!-- CWEID 80 -->
        <div> ic: ${jspvalic} </div>
        <div> id: ${jspvalid} </div>    <!-- CWEID 80 -->
        <div> ie: ${jspvalie} </div>
        <div> if: ${jspvalif} </div>    <!-- CWEID 80 -->
        <div> ig: ${jspvalig} </div>
        <div> ih: ${jspvalih} </div>    <!-- CWEID 80 -->
        <div> ii: ${jspvalii} </div>
        <div> ij: ${jspvalij} </div>    <!-- CWEID 80 -->
        <div>
            ik: 
            <div> val1: ${jspvalik.val1} </div>
            <div> val2: ${jspvalik.val2} </div> <!-- CWEID 80 -->
            <div> val3: ${jspvalik.val3} </div>
        </div>
        <div>
            il: 
            <div> val1: ${jspvalil.val1} </div> <!-- CWEID 80 -->
