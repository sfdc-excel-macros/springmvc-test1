...
<html lang="en">
    ...
    <body>
        ...
        <div> ea: ${jspvalea} </div>
        <div> eb: ${jspvaleb} </div>    <!-- CWEID 80 -->
        <div> ec: ${jspvalec} </div>
        <div> ed: ${jspvaled} </div>    <!-- CWEID 80 -->
        <div> ee: ${jspvalee} </div>
        <div> ef: ${jspvalef} </div>    <!-- CWEID 80 -->
        <div> eg: ${jspvaleg} </div>
        <div> eh: ${jspvaleh} </div>    <!-- CWEID 80 -->
        <div> ei: ${jspvalei} </div>
        <div> ej: ${jspvalej} </div>    <!-- CWEID 80 -->
        <div>
            ek: 
            <div> val1: ${jspvalek.val1} </div>
            <div> val2: ${jspvalek.val2} </div> <!-- CWEID 80 -->
            <div> val3: ${jspvalek.val3} </div>
        </div>
        <div>
            el: 
            <div> val1: ${jspvalel.val1} </div> <!-- CWEID 80 -->
